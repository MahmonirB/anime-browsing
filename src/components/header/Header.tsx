    ...
    return (
        ...
        <div className="container md:mx-auto md:flex md:items-center">
          ...
          <div className={`md:flex flex-col md:flex-row md:ml-auto mt-2 p-2 md:mt-0 w-full bg-white absolute md:relative md:w-1/2 transition duration-900 ${showNavbar ? 'flex' : 'hidden'}`} id="navbar-collapse">
            ...
            <a href="#" className="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300">Genres</a>
            <a href="#" className="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300">Studio</a>
